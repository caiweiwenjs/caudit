...
<div class="wrap">
  <div class="search">
  <form action="admin.php?a=AdminUser&do=search" method="post">
     用户名：
  ...
  <table cellspacing="1" class="mylist">
    ...
    <tr>
      <th colspan="6"><div class="relative">用户列表
        <div class="buttons">
            <a class="_add blue" href="admin.php?a=AdminUser&f=add" title="新增">
...
<select onchange="selectSubmit(this,'form_data_list')">
    <option>请选择</option>
    <option title="确认删除？删除后无法恢复！！" value="admin.php?a=AdminUser&f=delete">删除</option>
    <option value="admin.php?a=AdminUser&f=status&status=1">启用</option>
    <option value="admin.php?a=AdminUser&f=status&status=0">锁定</option>
</select>
</div>
